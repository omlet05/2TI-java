...
public class AccesBDGen
{
     ...
     * typedb == mysql or odbc
     */
    public static Connection connecter(String typedb, String bd, String user, String pass)
                throws SQLException{
    Connection connexion = null;
     try { 
    	 	if(typedb.equals("odbc")){
        	   ...
        	   connexion = DriverManager.getConnection("jdbc:mysql://localhost/"+bd,user,pass);
           }
         }
